...
from matplotlib.gridspec import GridSpec # Import matplotlib gridspec for subplot graphics
...
Alpha_Tau1 = 2.1 * 10 ** -5  # (N^-1) Coefficient for force-model parametertcin the fatigue model. '''Value from Ding's experimentation''' [1]
...
Tau_fat = 127000  # (s) Time constant controlling the recovery of the three force-model parameters (A,R0,tc) during fatigue. '''Value from Ding's experimentation''' [1]
...
u = create_impulse(33, 1000, 1000, 0, 300000)
